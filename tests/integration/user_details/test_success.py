...
def test_single_page(ods_code, page, correlation_id):
    ...
    Assertions.assert_200_response_nhs_app_accounts(resp, INT_URL, ods_code, 1)
...
def test_multi_pages(ods_code, page, correlation_id):
    ...
    Assertions.assert_200_response_nhs_app_accounts(resp, INT_URL, ods_code, self_page_in_response)
