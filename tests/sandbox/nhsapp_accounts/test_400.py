...
from lib.constants.nhsapp_accounts_paths import NHSAPP_ACCOUNTS_ENDPOINT, ODS_CODE_PARAM_NAME, PAGE_PARAM_NAME, \
    VALID_MULTI_PAGE_NUMBERS, INVALID_ODS_CODES, CORRELATION_IDS, INVALID_PAGES, MULTIPLE_PAGES_ODS_CODES
...
@pytest.mark.parametrize("correlation_id", CORRELATION_IDS)
def test_400_invalid_ods_code(nhsd_apim_proxy_url, ods_code, correlation_id):
