...
def test_201_message_batch_valid_accept_headers_sandbox(nhsd_apim_proxy_url, accept_headers):
    resp = requests.post(
...
def test_201_message_batch_valid_content_type_headers_sandbox(nhsd_apim_proxy_url, content_type):
...
def test_201_message_batch_valid_routing_plan_id_sandbox(nhsd_apim_proxy_url, routing_plan_id):
    resp = requests.post(f"{nhsd_apim_proxy_url}{REQUEST_PATH}", headers={
            "Accept": "application/json",
            "Content-Type": "application/json"
        }, json={
...
@pytest.mark.sandboxtest
def test_201_message_batch_valid_message_batch_reference_sandbox(nhsd_apim_proxy_url):
    resp = requests.post(f"{nhsd_apim_proxy_url}{REQUEST_PATH}", headers={
            "Accept": "application/json",
            "Content-Type": "application/json"
        }, json={
...
@pytest.mark.sandboxtest
def test_201_message_batch_valid_message_batch_sandbox(nhsd_apim_proxy_url):
    resp = requests.post(f"{nhsd_apim_proxy_url}{REQUEST_PATH}", headers={
            "Accept": "application/json",
            "Content-Type": "application/json"
        }, json={
...
@pytest.mark.sandboxtest
def test_201_message_batch_valid_nhs_number_sandbox(nhsd_apim_proxy_url):
    resp = requests.post(f"{nhsd_apim_proxy_url}{REQUEST_PATH}", headers={
            "Accept": "application/json",
            "Content-Type": "application/json"
        }, json={
...
def test_201_message_batch_valid_dob_sandbox(nhsd_apim_proxy_url, dob):
    resp = requests.post(f"{nhsd_apim_proxy_url}{REQUEST_PATH}", headers={
            "Accept": "application/json",
            "Content-Type": "application/json"
        }, json={
...
@pytest.mark.sandboxtest
def test_request_without_dob_sandbox(nhsd_apim_proxy_url):
    resp = requests.post(f"{nhsd_apim_proxy_url}{REQUEST_PATH}", headers={
        "Accept": "application/json",
        "Content-Type": "application/json"
        }, json={
