...
@pytest.mark.parametrize('accept_header_value', HEADER_VALUE)
@pytest.mark.parametrize('request_path', REQUEST_PATH)
def test_406_sandbox_with_correlation_id_get(nhsd_apim_proxy_url, accept_header_name,
                                             accept_header_value, request_path):
    resp = requests.get(f"{nhsd_apim_proxy_url}/{request_path}", headers={
        accept_header_name: accept_header_value,
...
@pytest.mark.parametrize('accept_header_value', HEADER_VALUE)
@pytest.mark.parametrize('request_path', REQUEST_PATH)
def test_406_sandbox_with_correlation_id_post(nhsd_apim_proxy_url, accept_header_name,
                                              accept_header_value, request_path):
    resp = requests.post(f"{nhsd_apim_proxy_url}/{request_path}", headers={
        accept_header_name: accept_header_value,
        "X-Correlation-id": x_correlation_id_value
...
@pytest.mark.parametrize('accept_header_value', HEADER_VALUE)
@pytest.mark.parametrize('request_path', REQUEST_PATH)
def test_406_sandbox_with_correlation_id_put(nhsd_apim_proxy_url, accept_header_name,
                                             accept_header_value, request_path):
    resp = requests.put(f"{nhsd_apim_proxy_url}/{request_path}", headers={
        accept_header_name: accept_header_value,
        "X-Correlation-id": x_correlation_id_value
...
@pytest.mark.parametrize('accept_header_value', HEADER_VALUE)
@pytest.mark.parametrize('request_path', REQUEST_PATH)
def test_406_sandbox_with_correlation_id_patch(nhsd_apim_proxy_url, accept_header_name,
                                               accept_header_value, request_path):
    resp = requests.patch(f"{nhsd_apim_proxy_url}/{request_path}", headers={
        accept_header_name: accept_header_value,
        "X-Correlation-id": x_correlation_id_value
...
@pytest.mark.parametrize('accept_header_value', HEADER_VALUE)
@pytest.mark.parametrize('request_path', REQUEST_PATH)
def test_406_sandbox_with_correlation_id_delete(nhsd_apim_proxy_url, accept_header_name,
                                                accept_header_value, request_path):
    resp = requests.delete(f"{nhsd_apim_proxy_url}/{request_path}", headers={
        accept_header_name: accept_header_value,
        "X-Correlation-id": x_correlation_id_value
...
@pytest.mark.parametrize('accept_header_value', HEADER_VALUE)
@pytest.mark.parametrize('request_path', REQUEST_PATH)
def test_406_sandbox_with_correlation_id_head(nhsd_apim_proxy_url, accept_header_name,
                                              accept_header_value, request_path):
    resp = requests.head(f"{nhsd_apim_proxy_url}/{request_path}", headers={
        accept_header_name: accept_header_value,
        "X-Correlation-id": x_correlation_id_value
...
@pytest.mark.parametrize('accept_header_value', HEADER_VALUE)
@pytest.mark.parametrize('request_path', REQUEST_PATH)
def test_406_sandbox_with_correlation_id_options(nhsd_apim_proxy_url, accept_header_name,
                                                 accept_header_value, request_path):
    resp = requests.get(f"{nhsd_apim_proxy_url}/{request_path}", headers={
        accept_header_name: accept_header_value,
        "X-Correlation-id": x_correlation_id_value
