...
def test_trip_429_app_quota(nhsd_apim_proxy_url, bearer_token_internal_dev, rate_limiting, correlation_id):
...
@pytest.mark.devperftest
def test_trip_429_app_spikearrest(nhsd_apim_proxy_url, bearer_token_internal_dev, rate_limiting):
...
@pytest.mark.devperftest
def test_trip_429_proxy_quota(nhsd_apim_proxy_url, bearer_token_internal_dev, rate_limiting):
...
@pytest.mark.devperftest
def test_trip_429_proxy_spikearrest(nhsd_apim_proxy_url, bearer_token_internal_dev, rate_limiting):
